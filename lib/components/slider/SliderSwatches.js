...
var SliderSwatches = exports.SliderSwatches = function (_ReactCSS$Component) {
  ...
  _createClass(SliderSwatches, [{
    ...
    value: function render() {
      console.log('this.props.hsl.l', this.props.hsl.l, this.props.hsl.s)
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_SliderSwatch2.default, _extends({}, this.props, { offset: '1.', active: Math.round(this.props.hsl.l * 100) / 100 == 1 && Math.round(this.props.hsl.s * 100) / 100 == 0, onClick: this.handleClick, first: true }))
        ),
        _react2.default.createElement(
          'div',
          { style: this.styles().swatch },
          _react2.default.createElement(_SliderSwatch2.default, _extends({}, this.props, { offset: '.80', active: Math.round(this.props.hsl.l * 100) / 100 == .80 && Math.round(this.props.hsl.s * 100) / 100 == .50, onClick: this.handleClick }))
        ),
        _react2.default.createElement(
          'div',
          { style: this.styles().swatch },
        ...
        _react2.default.createElement(
          'div',
          { style: this.styles().swatch },
          _react2.default.createElement(_SliderSwatch2.default, _extends({}, this.props, { offset: '.20', active: Math.round(this.props.hsl.l * 100) / 100 == .20 && Math.round(this.props.hsl.s * 100) / 100 == .50, onClick: this.handleClick }))
        ),
        _react2.default.createElement(
          'div',
          { style: this.styles().swatch },
          _react2.default.createElement(_SliderSwatch2.default, _extends({}, this.props, { offset: '.0', active: Math.round(this.props.hsl.l * 100) / 100 == 0 && Math.round(this.props.hsl.s * 100) / 100 == 0, onClick: this.handleClick, last: true }))
        ),
