    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { style: this.styles().swatch },
          _react2.default.createElement(_SliderSwatch2.default, _extends({}, this.props, { offset: '.15', active: Math.round(this.props.hsl.l * 100) / 100 == .15 && Math.round(this.props.hsl.s * 100) / 100 == .50, onClick: this.handleClick }))
        ),
        _react2.default.createElement(
          'div',
          { style: this.styles().swatch },
